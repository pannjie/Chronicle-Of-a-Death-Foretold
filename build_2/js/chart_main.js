...
gsap.registerPlugin(ScrollTrigger);
      ...
      const annotationText_dicedicedice = svg.append('text')
       ...
       annotationText_2.append('tspan')
        ...
        master.to(annotationLine_dicedicedice.node(), {opacity: 0, duration: 1}, 7)
          .to(annotationText_dicedicedice.node(), {opacity: 0, duration: 1}, 7)
          .to(dicedicediceLayer.node(), {opacity: 0, duration: 1}, 7)
