import * as d3 from "https://cdn.jsdelivr.net/npm/d3@7/+esm";
        ...
        const data =  (await d3.csv("../data/d3_df_idf.csv", d => ({
       ...
       const tooltip = d3.select('body')
        ...
        // fix and xAxis and yAxis
        // Make sure the directions are coloured the same scale
        // add hover function / cross chart highlighting
        // add legend
        // add animation?
        // why is the yaxis so weird