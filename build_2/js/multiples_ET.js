 import * as d3 from "https://cdn.jsdelivr.net/npm/d3@7/+esm";
        ...
        const data =  (await d3.csv("../data/d3_df_ET.csv", d => ({
       ...
       const tooltip = d3.select('body')
        ...
        svg.append('line')
        .attr('x1', x(new Date("2026-02-28T05:30:00Z")))
        .attr('x2', x(new Date("2026-02-28T05:30:00Z")))
        ...
        svg.append('text')
        .attr('x', x(new Date("2026-02-28T05:30:00Z")))
