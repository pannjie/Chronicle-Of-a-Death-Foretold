 import * as d3 from "https://cdn.jsdelivr.net/npm/d3@7/+esm";
        ...
        const data =  (await d3.csv("../data/d3_df_28.csv", d => ({
        ...
        const totalWidth = d3.select('.standard_1').node().getBoundingClientRect().width;
        const totalHeight = d3.select('.standard_1').node().getBoundingClientRect().height;
       ...
       const tooltip = d3.select('body')
        ...
        const svg = d3.select('.standard_1').append('svg')
        ...
        svg.append('line')
        .attr('x1', x(new Date("2026-02-28T05:15:00Z")))
        .attr('x2', x(new Date("2026-02-28T05:15:00Z")))
        ...
        svg.append('text')
        .attr('x', x(new Date("2026-02-28T05:15:00Z")))
